...
<div class="bg-white rounded-lg shadow-md p-6 max-w-2xl mx-auto">
    ...
    <form action="{{ route('kategori.update', $kategori->id) }}" method="POST" class="space-y-5">
        ...
        <div class="flex gap-3 pt-2">
            <button type="submit" class="bg-blue-600 text-white px-5 py-2.5 rounded-md hover:bg-blue-700 transition-colors duration-200 font-medium flex-grow md:flex-grow-0">
                Update
            </button>
